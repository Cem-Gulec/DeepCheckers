...
class Coach():
    ...
    def executeEpisode(self):
        ...
        while True:
            ...
            if self.curPlayer == -1: self.get_new_pi_mini(pi)
    ...
    def learn(self):
        ...
        for i in range(1, self.args.numIters + 1):
            ...
            with open("out.txt", "a") as myfile:
                myfile.write(f'Starting Iter #{i} ...\n')
            ...
            if not self.skipFirstSelfPlay or i > 1:
                ...
                for _ in tqdm(range(self.args.numEps), desc="Self Play"):
                    ...
                    with open("out.txt", "a") as myfile:
                        myfile.write(f'MCTS total node count is {self.mcts.totalNodeCount} and total repetition count is {self.mcts.repNodeCount}\n')
            ...
            with open("out.txt", "a") as myfile:
                myfile.write('PITTING AGAINST PREVIOUS VERSION\n')
            ...
            with open("out.txt", "a") as myfile:
                myfile.write(f'NEW/PREV WINS : {nwins} / {pwins} ; DRAWS : {draws}\n')

            if pwins + nwins == 0 or float(nwins) / (pwins + nwins) < self.args.updateThreshold:
                log.info('REJECTING NEW MODEL')
                with open("out.txt", "a") as myfile:
                    myfile.write('REJECTING NEW MODEL\n')

                self.nnet.load_checkpoint(folder=self.args.checkpoint, filename='temp.pth.tar')
            else:
                log.info('ACCEPTING NEW MODEL')
                with open("out.txt", "a") as myfile:
                    myfile.write('ACCEPTING NEW MODEL\n')
