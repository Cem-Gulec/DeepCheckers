...
args = dotdict({
    'lr': 0.001,
    'dropout': 0.3, ##0.5 de olabilir
    'epochs': 10, #değişir
    'batch_size': 64, ##değişir
    'num_channels': 512, ##filtre sayısı 32---->512 arası değişir
})
...
class NNetWrapper(NeuralNet):
    def __init__(self, game):
        ...
        self.sess = tf.Session(graph=self.nnet.graph) #prosedür tf graphı bunun üzerinde çalışır
        self.saver = None
